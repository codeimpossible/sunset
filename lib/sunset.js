...
module.exports = {
    ...
    bindEvents() {
        atom.config.observe('sunset.nighttime_ui_theme', (() => {
            this.hasBeenConfigured = true;
            this.setup();

            this.tick();
        }));
        atom.config.observe('sunset.nighttime_syntax_theme', (() => {
            this.hasBeenConfigured = true;
            this.setup();

            this.tick();
        }));
        atom.config.observe('sunset.daytime_ui_theme', (() => {
            this.hasBeenConfigured = true;
            this.setup();
        ...
        atom.config.observe('sunset.daytime_syntax_theme', (() => {
            this.hasBeenConfigured = true;
            this.setup();
    ...
    tick() {
        ...
        const twentyFourHour = (now.getHours() * hoursToMinutesFactor) + now.getMinutes();
