...
module.exports = {
  config: {
    ...
    use_geolocation: {
      ...
      description: `Use your geolocation (via http://freegeoip.net) to automatically determine sun
  ...
  getLocation() {
    ...
    request.get(url).then((response) => {
      ...
      atom.config.set('sunset.when_does_it_get_dark', this.getTwentyFourHourTime(times.sunsetStart));
    }).catch((error) => {
